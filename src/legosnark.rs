...
pub fn legosnark_decompress_pk(
    ...
    let snark_pk = obj_from_uint8array!(LegoProvingKey, snark_pk, "LegoProvingKey");
...
pub fn legosnark_vk_from_pk(
    ...
    Ok(if return_uncompressed {
        ...
        obj_to_uint8array!(&snark_pk.vk, "LegoVerifyingKey")
    })
}
...
pub fn legosnark_decompress_vk(
    ...
    let snark_vk = obj_from_uint8array!(LegoVerifyingKey, snark_vk, "LegoVerifyingKey");

const { wasm, requireWasmInitialized } = require("./init_wasm");
...
module.exports.PS_SIGNATURE_LENGTH = 96;
...
module.exports.psBlindMessageRandomly = function (message) {
  requireWasmInitialized();
  return wasm.psBlindMessageRandomly(message);
};

module.exports.psRevealMessage = function (message) {
  requireWasmInitialized();
...
module.exports.psBlindedMessage = function (commitment) {
  requireWasmInitialized();
  return wasm.psBlindedMessage(commitment);
};

module.exports.psRevealedMessage = function (message) {
  requireWasmInitialized();
...
module.exports.psAdaptSecretKeyForMoreMessages = (
  secretKey,
  seed,
  messageCount
) => {
...
module.exports.psSign = (messages, secretKey, params) => {
  requireWasmInitialized();
  return wasm.psSign(messages, secretKey, params);
};

module.exports.psVerify = (messages, signature, publicKey, params) => {
  requireWasmInitialized();
...
module.exports.psMultiMessageCommitment = (messages, h, g, blinding) => {
  requireWasmInitialized();
  return wasm.psMultiMessageCommitment(messages, h, g, blinding);
};
...
module.exports.psInitializeMessagesPoK = (params, h, messages) => {
  requireWasmInitialized();
  return wasm.psInitializeMessagesPoK(params, h, messages);
};

module.exports.psGenSignaturePoK = (protocol, challenge) => {
  requireWasmInitialized();
  return wasm.psGenSignaturePoK(protocol, challenge);
};

module.exports.psGenMessagesPoK = (protocol, challenge) => {
  requireWasmInitialized();
...
module.exports.psVerifySignaturePoK = (
  ...
  requireWasmInitialized();
  return wasm.psVerifySignaturePoK(
    proof,
    revealedMessages,
    challenge,
    publicKey,
...
module.exports.psChallengeSignaturePoKContributionFromProtocol = (
  ...
  requireWasmInitialized();
  return wasm.psChallengeSignaturePoKContributionFromProtocol(
    protocol,
    revealedMessages,
    params
  );
...
module.exports.psChallengeMessagesPoKContributionFromProtocol = (
  ...
  requireWasmInitialized();
  return wasm.psChallengeMessagesPoKContributionFromProtocol(
    protocol,
    params,
    h
  );
...
module.exports.psChallengeSignaturePoKContributionFromProof = (
  ...
  requireWasmInitialized();
  return wasm.psChallengeSignaturePoKContributionFromProof(
    proof,
    publicKey,
    params
  );
...
module.exports.psAdaptSignatureParamsForMsgCount = (
  params,
  generating_label,
  new_count
) => {
  requireWasmInitialized();
  return wasm.psAdaptSignatureParamsForMsgCount(
    params,
    generating_label,
    new_count
  );

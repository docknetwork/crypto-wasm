...
module.exports.accumulatorParamsToBytes = async (params) => {
    await initialize();
    return throwErrorOnRejectedPromise(
        wasm.accumulatorParamsToBytes(params)
    );
};

module.exports.accumulatorParamsFromBytes = async (bytes) => {
    await initialize();
    return throwErrorOnRejectedPromise(
        wasm.accumulatorParamsFromBytes(bytes)
    );
};
...
module.exports.accumulatorPublicKeyToBytes = async (pk) => {
    await initialize();
    return throwErrorOnRejectedPromise(
        wasm.accumulatorPublicKeyToBytes(pk)
    );
};

module.exports.accumulatorPublicKeyFromBytes = async (bytes) => {
    await initialize();
    return throwErrorOnRejectedPromise(
        wasm.accumulatorPublicKeyFromBytes(bytes)
    );
};
...
module.exports.updateMembershipWitnessesPostBatchUpdates = async (witnesses, members, additions, removals, oldAccumulated, secretKey) => {
    await initialize();
    return throwErrorOnRejectedPromise(
        wasm.updateMembershipWitnessUsingPublicInfoAfterBatchUpdate(witnesses, members, additions, removals, oldAccumulated, secretKey)
    );
};

module.exports.updateNonMembershipWitnessesPostBatchUpdates = async (witnesses, nonMembers, additions, removals, oldAccumulated, secretKey) => {
    await initialize();
    return throwErrorOnRejectedPromise(
        wasm.updateMembershipWitnessUsingPublicInfoAfterBatchUpdate(witnesses, nonMembers, additions, removals, oldAccumulated, secretKey)
    );
};

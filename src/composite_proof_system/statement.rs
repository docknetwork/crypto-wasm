...
pub(crate) type PoKBbsPSigStmt = statement::bbs_23::PoKBBSSignature23G1<Bls12_381>;
...
#[wasm_bindgen(js_name = generatePoKBBSSignatureG1Statement)]
pub fn generate_pok_bbs_sig_statement(
    ...
    let statement = PoKBbsPSigStmt::new_statement_from_params::<G1Affine>(params, pk, msgs);
